...
graph RL;
  ...
  click B_6 "https://github.com/e53e04ac/ipp5-types/tree/228a79560e81a38fca36baec24e5729d1f36bb9f";
~~~~~
...
graph RL;
  subgraph "e53e04ac/ipp5-backend-batch-launcher";
    E_0(["type Ipp5BackendBatchLauncher"]);
    E_1(["const Ipp5BackendBatchLauncher"]);
  end;
  M(["index.d.ts"])
  subgraph "azure-terraformer";
    I_0_0(["AzureTerraformer"]);
